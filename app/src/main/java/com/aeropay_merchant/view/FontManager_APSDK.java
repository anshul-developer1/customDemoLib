...
public class FontManager_APSDK {
    private static FontManager_APSDK manager;
    ...
    private FontManager_APSDK(Context context) {
        this.context = context;
    }

    public static FontManager_APSDK getInstance(Context context) {
        if (manager == null) {
            manager = new FontManager_APSDK(context);
        }
        return manager;
    }
    ...
    public void setTypeFace(View view, String fontName) {
        ...
        if (typeface == null) {
            typeface = FontManager_APSDK.findTypeface(context, "font", fontName);
