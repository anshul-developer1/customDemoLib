...
object KeystoreManager_APSDK {
    ...
    private var encryptorAPSDK: KeystoreEncryptor_APSDK = KeystoreEncryptor_APSDK()
    private var decryptorAPSDK: KeystoreDecryptor_APSDK = KeystoreDecryptor_APSDK()
