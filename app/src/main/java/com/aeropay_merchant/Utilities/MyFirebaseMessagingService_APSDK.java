...
import com.aeropay_merchant.activity.NavigationMenuActivity_APSDK;
import com.google.firebase.messaging.FirebaseMessagingService;
import com.google.firebase.messaging.RemoteMessage;

public class MyFirebaseMessagingService_APSDK extends FirebaseMessagingService {
    ...
    public void onNewToken(String s) {
        super.onNewToken(s);
        PrefKeeper_APSDK.INSTANCE.setDeviceToken(s);
    }
    ...
    private void sendNotification(String title, String messageBody) {
        Intent intent = new Intent(getApplicationContext(), NavigationMenuActivity_APSDK.class);
