...
class NavigationMenuAdapter_APSDK(context: Context?, private val menuItemsNameArray: Array<String>, private val menuItemsImageArray: Array<Int>) : ArrayAdapter<String>(context!!, R.layout.navigation_menu_items_apsdk, menuItemsNameArray){
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        val rowView = inflater.inflate(R.layout.navigation_menu_items_apsdk, null, true)
