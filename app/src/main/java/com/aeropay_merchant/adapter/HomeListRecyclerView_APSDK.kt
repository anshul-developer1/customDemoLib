...
import kotlinx.android.synthetic.main.home_recycler_layout_apsdk.view.*
...
class HomeListRecyclerView(val payerName : ArrayList<String>, val context: Context) : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.home_recycler_layout_apsdk, parent, false))
    }
